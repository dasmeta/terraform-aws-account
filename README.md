...
| <a name="module_cloudtrail"></a> [cloudtrail](#module\_cloudtrail) | dasmeta/modules/aws//modules/cloudtrail/ | 1.7.0 |
...
| <a name="input_log_metrics"></a> [log\_metrics](#input\_log\_metrics) | Provide CloudWatch Log Metric filters | <pre>object({<br>    enabled = optional(bool, false)<br>    metrics_patterns = optional(list(object({<br>      name       = optional(string, "ERROR")<br>      pattern    = optional(string, "ERROR")<br>      unit       = optional(string, "None")<br>      dimensions = optional(map(string), {})<br>    })), [])<br>    metrics_namespace = optional(string, "LogBasedMetrics")<br>  })</pre> | <pre>{<br>  "enabled": false<br>}</pre> | no |
